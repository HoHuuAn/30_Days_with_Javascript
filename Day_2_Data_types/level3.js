...
console.log(sentence.replace(/[^\w\s]/gi, '').toLowerCase())

const sentence1 = 'He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.'
console.log(sentence1.match(/\d+/g).reduce((accumulator, currentValue) => parseInt(accumulator) + parseInt(currentValue), 0))
